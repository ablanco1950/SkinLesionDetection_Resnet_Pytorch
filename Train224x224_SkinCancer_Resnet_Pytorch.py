#
# By Alfonso Blanco García, March 2024
...
train_data = datasets.ImageFolder( 'Dir_SkinCancer_Resnet_Pytorch/train', transform=train_transforms)
test_data = datasets.ImageFolder( 'Dir_SkinCancer_Resnet_Pytorch/valid', transform=test_transforms)
